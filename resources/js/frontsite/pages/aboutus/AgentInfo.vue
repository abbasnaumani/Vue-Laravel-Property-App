<template>
    <top-banner pageName="Agents Info" link="about"></top-banner>
                            ...
                            <div class="col mb-4">
                                ...
                                <div class="row pb-4">
                                    <div class="col-md-5">
                                        <div class="border-radius-agents overflow-hidden-agents">
                                            <a href="#">
                                                <img class="img-fluid" src="/assets/images/img-21.jpg" alt="">
                                            </a>
                                        </div>
                                    </div>
                                    <div class="col-md-7">
                                ...
                                <div class="row pb-4">
                                    <div class="col-md-5">
                                        <div class="border-radius-agents overflow-hidden-agents">
                                            <a href="#">
                                                <img class="img-fluid" src="/assets/images/img-12.jpg" alt="">
                                            </a>
                                        </div>
                                    </div>
                                    <div class="col-md-7">
                                ...
                                <div class="row pb-4">
                                    <div class="col-md-5">
                                        <div class="border-radius-agents overflow-hidden-agents">
                                            <a href="#">
                                                <img class="img-fluid" src="/assets/images/img-22.jpg" alt="">
                                            </a>
                                        </div>
                                    </div>
                                    <div class="col-md-7">
                                ...
                                <div class="row pb-4">
                                    <div class="col-md-5">
                                        <div class="border-radius-agents overflow-hidden-agents">
                                            <a href="#">
                                                <img class="img-fluid" src="/assets/images/img-11.jpg" alt="">
                                            </a>
                                        </div>
                                    </div>
                                    <div class="col-md-7">
