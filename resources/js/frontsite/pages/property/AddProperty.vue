                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9">
                                            <div class="d-flex align-items-center">
                                                <div class="btn btn-check border-right">
                                                    <div class="form-check ">
                                                        <input type="radio" class="form-check-input" id="" name="propertytype" data-toggle="collapse" data-target=".multi-collapse" aria-expanded="false" aria-controls="multiCollapseExample1 multiCollapseExample2">
                                                ...
                                                <div class="btn btn-check border-right">
                                                    <div class="form-check">
                                                        ...
                                                        <label class="form-check-label" >Commerical</label>
                                                    </div>
                                                </div>
                                            </div>
                                            <!-- drop data -->
