        ...
        <div class="row">
          <div class="col-lg-7">
            <div
              ...
              style="width: 100%; padding-bottom: 180px"
            >
              <div id="demo" class="carousel slide" data-ride="carousel">
                ...
                <a class="carousel-control-prev prev" href="#demo" data-slide="prev">
                  <span class="icon-indicators rounded d-flex justify-content-center align-items-center"
                    ><i class="fas fa-angle-left icon text-white"></i
                  ></span>
                </a>
                <a class="carousel-control-next next" href="#demo" data-slide="next">
                  <span class="icon-indicators rounded d-flex justify-content-center align-items-center"
                    ><i class="fas fa-angle-right icon text-white"></i
                  ></span>
                </a>
                <!-- <a class="carousel-control-prev" href="#demo" data-slide="prev">
                  <span class="icon-indicators"
                ...
                <div id="demo" class="carousel slide mt-4" data-ride="carousel">
                  ...
                  <div class="carousel-inner">
                    <div class="carousel-item active text-center">
                      <img
                        style="max-width: 110px; border-radius: 100%"
                        id="img"
                      ...
                      <a
                        ...
                        class="
                          text-white
                          d-lg-block d-md-block d-sm-block d-block
                        "
                        >(800) 123-4567</a
                      >
                      <a
...
export default {
  name: "PropertyDetail",
  components: { ContactUs, BottomBanner },
  props: {
    slug: String,
    propertyId: Number,
  },
