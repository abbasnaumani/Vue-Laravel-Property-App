<template>
    <!-- Carousel -->
    <section class="crousal-section py-2">
                ...
                <div id="demo" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img class="imggg" src="/assets/images/img-2.jpg" alt="Los Angeles" height="700" width="100%">
                            <div class="carousel-caption d-flex justify-content-end card-animation">
                                <!-- slider card  -->
                                <div class="container">
                        ...
                        <div class="carousel-item">
                            <img class="imggg" src="/assets/images/img-1.jpg" alt="Chicago" height="700" width="100%">
