<template>
    ...
    <section class="footer-section">
        <footer class="footer border border-0 container-fluid margin footer-color">
                        ...
                        <div class="row py-3 mt-5">
                            <div class="col-md-4 col-lg-3">
                                <div>
                                    ...
                                    <div>
                                        <span class="text-white footer-p">Email :</span>
                                        <a class="text-decoration-none anchor" href="#">
                                            mail@example.com</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4 col-lg-5">
                                <div>
                                    ...
                                    <a href="#"
                                       class="text-white footer-A text-decoration-none d-lg-block d-md-block d-sm-block d-block">01:05
                                        PM Sep 18th</a>
                                </div>
                            </div>
                        </div>
            ...
            <div class="container-fluid margin footer-divider">
