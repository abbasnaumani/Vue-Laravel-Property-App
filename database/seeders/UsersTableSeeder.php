...
class UsersTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $users = [
            ...
            ['id' => 3, 'first_name' => 'Muhammad', 'last_name' => 'Saddique', 'email' => 'kodestudio1@gmail.com', 'phone_number' => '+923161880989', 'password' => bcrypt('12345678'), 'is_active' => 1, 'is_approved' => 1, 'created_at' => Carbon::now()->format('Y-m-d H:i:s')],
            ['id' => 4, 'first_name' => 'Muhammad', 'last_name' => 'Saddique', 'email' => 'saddiquearain99@gmail.com', 'phone_number' => '+923161880989', 'password' => bcrypt('12345678'), 'is_active' => 1, 'is_approved' => 1, 'created_at' => Carbon::now()->format('Y-m-d H:i:s')],
        ];
